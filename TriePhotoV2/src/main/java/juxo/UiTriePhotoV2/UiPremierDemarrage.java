...
//panel 2	: option de tri	
		...
		JLabel TxtOptionTri = new JLabel("<html>Ci dessous les options disponibles pour le tri de vos photos.<br> De maniere automatique vos photos seront triees par annes et par mois, par exemple une photo prise au 1er janvier 2015<br> sera placé dans le dossier: ' .../2015/1'. Si vous souhaitez simplement ce mode de tri, cliquer sur trier mes photos.<br>Passer votre souris sur les autre options de tri pour plus d'information </html>");
		JLabel TxtOptionTri2 = new JLabel("<html><i>Si vous selectionnez plusieurs options, l'application essaiera en priorité de trier vos photos par evenement, puis par lieu, <br>si ces informations ne sont disponible, vos photos seront triees par date </i></html>");
		...
		Jour.setToolTipText("Vos photos seront triees par jour, ainsi une photo prise au 1er janvier 2015 sera placé dans le dossier: ' .../2015/1/1'");
		Evenement.setToolTipText("<html>Vos photos seront triees par evenement, ainsi une photo prise au 1er janvier 2015 et correspondant à un evenement de votre calendrier a cette date sera placee dans le dossier: ' .../2015/1/'nom de mon evenement' <br> Noter qu'une autorisation de connexion de l'application a Google sera necessaire. Pour plus d'information, voir la partie connexion a Google.</html> ");
		Lieu.setToolTipText("Vos photos seront triees par Lieu (si ce dernier est disponible), ainsi une photo prise au 1er janvier 2015 a Pessac sera placé dans le dossier: ' .../2015/1/Pessac'");
...
//panel 3 : Renommage		
		...
		JLabel TxtRenommage = new JLabel("<html>Vous avez la possibilité de renommer selon differentes options les photos d'un dossier de votre choix. </html>");
...
//ajout des pannels 123 à onglet 1:
		onglet1.add(pan1);
		onglet1.add(pan2);
		onglet1.add(pan3);
...
/////////onglet 2 :  connexion googgle//////////////////////
		...
		onglet2.setBackground(Color.WHITE);
				...
				JLabel TxtGoogle = new JLabel("<html><br>Vous avez la possibilité de trier vos photos en fonction de vos calenderiers d'evenements. <br> Pour se faire, une connexion a Google est necessaire afin d'acceder à vos calendriers.<br> Pour plus de sécurité un code d'authentification vous sera envoyer afin d'autoriser la connexion.</html>");
			...
			//	JLabel TxtGoogle3 = new JLabel("<html><br>Veuillez entrer ce code ci dessous:<html>");
				JLabel TxtGoogle4 = new JLabel("<html><i>Ce code ne devrait vous etre demander q'une seule fois. <br>Si toutrefois vous devriez avoir à le fournir a nouveau, il vous sera possible de le faire a partir des parametres.</i><html>");
			...
			//	JTextField authentification = new JTextField(60);
				...
				JButton boutonReinitial = new JButton("Réinitialiser votre connexion Google");
...
////////onglet 3 : frequence de tri  ////////////////
		...
		JLabel txtFrequence = new JLabel("<html><br>Choisissez ici la frequence à laquelle l'application verifie si votre dossier source contient des photos: </html>");
...
////////menu a onglet : ///////////////////
        ...
        UIManager.put("TabbedPane.selected",Color.white); // si on veut changer la couleur des onglets selectionnés
       ...
       Icon iconeFrequence = new ImageIcon((getClass().getResource("Resource\\horloge-icone.png")));
        ...
        Onglets.addTab("<html><H4>Connexion Google</H4></html>",iconeGoogle,onglet2,"Connexion à vos calendriers");
        Onglets.addTab("<html><H4>Frequence de vérification</H4></html>",iconeFrequence,onglet3,"Choisissez à quelle frequence l'application trie les photos de votre dossier source ");
