...
////////////////////_________________________ Onglet tri ___________________________	   
      ...
      //////////////// _____________________________________ Onglet g�n�ral ________________________
	    ...
	    TitledBorder bordureOptionApp = (BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(128,128,128),2),"<html><H3>Fr�quence</H3></html>"));
	...
	//////////////___________________________________ Onglet Connexion Google __________________________
	    ...
	    TitledBorder bordureReInit = (BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(255,0,240),2),"<html><H3>R�initialisation</H3></html>"));
